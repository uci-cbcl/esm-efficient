import torch
from esme.alphabet import tokenize, Alphabet3
...
def test_MaskMarginDataset():
    ...
    assert dataset[50]['token'][dataset[50]['local_pos']] == Alphabet3.mask_idx

    token = tokenize([seq])[0][26:76]
    token[25] = Alphabet3.mask_idx
